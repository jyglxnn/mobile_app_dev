...
public anywheresoftware.b4a.objects.EditTextWrapper _text = null;
...
String _userinput = "";
 //BA.debugLineNum = 41;BA.debugLine="Private Sub Button_Click";
 //BA.debugLineNum = 42;BA.debugLine="Dim UserInput As String";
_userinput = "";
 //BA.debugLineNum = 43;BA.debugLine="UserInput = Text.Text";
_userinput = mostCurrent._text.getText();
 //BA.debugLineNum = 44;BA.debugLine="xui.MsgboxAsync(UserInput,\"You Entered\")";
_xui.MsgboxAsync(processBA,BA.ObjectToCharSequence(_userinput),BA.ObjectToCharSequence("You Entered"));
...
mostCurrent._header = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Private Label As Label";
mostCurrent._label = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Private Text As EditText";
mostCurrent._text = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Private Button As Button";
